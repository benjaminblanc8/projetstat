...
# =========================
# 1. CHECK DE BASE (évite erreurs silencieuses Quarto)
# =========================
stopifnot(exists("pisa_oecd_clean"))

# =========================
# 2. CRÉATION DES GROUPES PAYS
# =========================
niveau_pays <- pisa_oecd_clean %>%
  group_by(CNT) %>%
  summarise(
...
=======
# =========================
# 4. GRAPHIQUE SAFE PDF
# =========================
ggplot(hisced_pays,
       aes(x = hisced_mean, y = score_moyen, color = groupe)) +
  geom_point(size = 2) +
  geom_text_repel(
    aes(label = CNT),
    size = 3,
...
>>>>>>> 89d23512876b9b267e24f1db20b9eaaacf328b58
  ...
  labs(
    x = "Niveau d’éducation parental moyen (HISCED)",
    y = "Score moyen global",
<<<<<<< HEAD
    caption = "Source : PISA 2022 — OCDE"
=======
    caption = "Source : PISA 2022 — OCDE.\nNOTE DE LECTURE : En Israël, l'indice HISCED moyen est de 8 pour un score global moyen d'environ 449"
>>>>>>> 89d23512876b9b267e24f1db20b9eaaacf328b58
  ) +
  theme_minimal() +
  theme(
