...
ggplot(mat_r_long, aes(x = score, y = label_var, fill = r)) +
  ...
  labs(
    x = NULL,
    y = NULL,
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture: Le coefficient de corrélation entre le statut socio-économique et le score global et de 0.41"
  ) +
...
ggplot(mat_r_long, aes(x = matiere, y = label_var, fill = r)) +
  ...
  labs(
    x = NULL, y = NULL,
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture :le coefficient de corrélation entre le nombre d'heure de cours hebdomadaire et le score global \n est de 0.22"
  ) +
  theme_minimal(base_size = 11) +
  theme(
    plot.title    = element_text(face = "bold", size = 12),
...
ggplot(mat_eta_long, aes(x = matiere, y = label_var, fill = eta)) +
  ...
  labs(
    x = NULL, y = NULL,
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture : 0,49 : le nombre de livres à la maison est associé à 49% des différences de réussite scolaire"
  ) +
  theme_minimal(base_size = 11) +
  theme(
    plot.title   = element_text(face = "bold", size = 12),
...
labels_eta <- c(
  ...
  HISCED     = "niveau max éducation parent",
  FISCED     = "niveau éducation père",
  MISCED     = "niveau éducation mère",
  ST004D01T  = "genre",
...
ggplot(mat_eta_long, aes(x = matiere, y = label_var, fill = eta)) +
  ...
  labs(
    x = NULL, y = NULL,
    caption = "Source : PISA 2022 — OCDE. \nChamp : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture :  0,46 : le nombre de livres à la maison est\n associé à 65% des différences de réussite scolaire."
  ) +
  theme_minimal(base_size = 11) +
  theme(
    plot.title   = element_text(face = "bold", size = 12),
...
pisa_oecd_clean %>%
  ...
  labs(
    ...
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture: Le score global moyen d'un natif est de 485,1."
  ) +
  theme_minimal() +
...
pisa_oecd_clean %>%
  ...
  labs(
    ...
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture : le score global moyen d'un élève n'ayant jamais redoublé est de 487,8."
  ) +
  theme_minimal() +
  theme(legend.position = "none",
        plot.caption = element_text(size = 8, color = "grey40", hjust = 0))
...
pisa_oecd_clean %>%
  ...
  x = "Absences prolongées", y = "Score moyen",
    caption = "Source : PISA 2022 — OCDE. Champ : élèves de 15 ans des pays membres de l'OCDE.\nNote de lecture : le score global moyen n'ayant jamais eu d'absences prolongées."
  ) +
  theme_minimal() +
  theme(legend.position = "none",
        plot.caption = element_text(size = 8, color = "grey40", hjust = 0))
...
# =========================
# 2. CRÉATION DU DATASET (AUTONOME)
# =========================
...
ggplot(hisced_pays,
  ...
  labs(
    title = "Lien entre niveau d’éducation parental moyen et performance des pays",
