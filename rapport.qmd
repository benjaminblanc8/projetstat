...
```{r fig-cap="-acp-contrib", echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=4}
...
```{r fig-cap="-acp-cos2", echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
...
```{r fig-cap="-acp-synthese", echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=5}
