...
```{r, label="fig-10", fig.cap="Corrélation entre variables quantitatives et scores scolaires", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r, label="fig-11", fig.width=6, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE }
...
```{r, label="tbl-11", tab.cap="Tableau des 5 vairables les plus liées au score global", echo=FALSE, fig.width=8, fig.height=6, message=FALSE, warning=FALSE}
# ─────────────────────────────────────────────────────────────
