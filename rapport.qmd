...
df <- data.frame(
  Catégorie = c(
    ...
    rep("Caractéristiques individuelles\net environnement familial", 13)
  ),
  Variable = c(
    # Résultats
...
flextable(df) |>
  ...
  bg(i = ~ Catégorie == "Caractéristiques individuelles\net environnement familial", bg = "#E8DFF5", part = "body") |>
  ...
  color(j = "Catégorie",
        ...
        color = "#7B2C2C") |>
  color(j = "Catégorie",
        i = ~ Catégorie == "Caractéristiques individuelles\net environnement familial",
        color = "#5B2C6F") |>
